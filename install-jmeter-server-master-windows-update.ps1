...
wget https://publicsre.blob.core.windows.net/jmeter-scale/apache-jmeter-5.6.3.zip -OutFile apache-jmeter-5.6.3.zip
wget https://publicsre.blob.core.windows.net/jmeter-scale/microsoft-jdk-17.0.14-windows-x64.msi -OutFile microsoft-jdk-17.0.14-windows-x64.msi

############################# Instalacao Passiva (MSI compatible)

Expand-Archive -Path C:\YAMAN\FERRAMENTAS\apache-jmeter-5.6.3.zip -DestinationPath C:\YAMAN\FERRAMENTAS\
...
Start-Process C:\YAMAN\FERRAMENTAS\microsoft-jdk-17.0.14-windows-x64.msi -ArgumentList "/quiet /passive"
...
$Env:JMETER_HOME='C:\YAMAN\FERRAMENTAS\apache-jmeter-5.6.3'

[Environment]::SetEnvironmentVariable("JAVA_HOME","C:\Program Files\Microsoft\jdk-17.0.14.7-hotspot","Machine")
[Environment]::SetEnvironmentVariable("JMETER_HOME","C:\YAMAN\FERRAMENTAS\apache-jmeter-5.6.3","Machine")
...
New-NetFirewallRule -DisplayName 'JMETER-PORT-INBOUND' -Profile @('Domain','Private','Public') -Direction Inbound -Action Allow -Protocol TCP -LocalPort @('2000')
New-NetFirewallRule -DisplayName 'JMETER-PORT-INBOUND' -Profile @('Domain','Private','Public') -Direction Inbound -Action Allow -Protocol TCP -LocalPort @('5000')
